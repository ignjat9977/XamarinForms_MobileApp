...
{
    public class UpdateProductPageValidator : AbstractValidator<ProducttUpdateViewModel>
    {
        private Db _db;
        public UpdateProductPageValidator()
        {
            RuleFor(x => x.Name).Cascade(CascadeMode.Stop)
                ...
                .Must(ProductNameIsNotInUse).WithMessage("Product name already in use!");
